...
int ejecutarScriptRedireccionandoIO(char *, char *, char *, char *); //Recibe un archivo de entrada, uno de salida, direccion del script y nombre del script a ejecutar.
