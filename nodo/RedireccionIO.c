...
int redirecciona(char* dirArchivoEntrada, char* dirArchivoSalida,
		char* ptrScript)
{

	printf("Ejecutando \n");

	if (ejecutarScriptRedireccionandoIO(dirArchivoSalida, dirArchivoEntrada,
			ptrScript, "") == 0)
	{
