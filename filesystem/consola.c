...
int levantaConsola() {
	int indiceComando;
	char* comando = malloc(200); //reserva espacio para el comando a ingresar
	char* funcion = malloc(200); //reserva para la funcion
	char* dir = malloc(1000); //reserva para el directorio
	...
	while (1) { //ciclo del while para que la consola siga preguntado por otras funciones
		...
		printf("ingrese el comando. Ingrese man para ver un listado de comandos>>>");
