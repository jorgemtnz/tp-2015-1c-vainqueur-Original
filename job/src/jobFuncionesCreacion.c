...
t_solicitudDeTrabajo* crearSolicitudDeTrabajo()
{
	...
	{
		perror(
				"[ERROR] No se aloco memoria para SolicitudDeTrabajo pertenece a la estructura Job>..>SolicitudDeTrabajo");
		exit(-1);
	}
	else
	{
...
t_relacionNodoBloque* crearRelacionNodoBloque()
{
	...
	{
		perror(
				"[ERROR] No se aloco memoria para RelacionNodoBloque pertenece a la estructura Job>..>RelacionNodoBloque");
		exit(-1);
	}
	else
	{
...
t_relacionNodoArchTemp* crearRelacionNodoArchTemp()
{
	...
	{
		perror(
				"[ERROR] No se aloco memoria para RelacionNodoArchTemp pertenece a la estructura Job>..>RelacionNodoArchTemp");
		exit(-1);
	}
	else
	{
...
t_tareaMap* crearTareaMap()
{
	...
	{
		perror(
				"[ERROR] No se aloco memoria para TareaMap pertenece a la estructura Job>..>TareaMap");
		exit(-1);
	}
	else
	{
...
t_tareaReduce* creaTareaReduce()
{
	...
	{
		perror(
				"[ERROR] No se aloco memoria para TareaReduce pertenece a la estructura Job>..>TareaReduce");
		exit(-1);
	}
	else
	{
